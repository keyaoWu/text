package com.bawei.unit4_test1_demo.adapter;
...
import com.bawei.unit4_test1_demo.R;
...
public class MyAdapter extends BaseAdapter {
    ...
    private List<MyData.ListdataBean> mlist;

    public MyAdapter(Context mcontext, List<MyData.ListdataBean> mlist) {
